...
public class Particula {
	 ...
	 * 
	 * @param dimensoes Número de dimensões do espaço de busca.
	 */
	 ...
	 * 
	 * @param currentPosition a posição atual da partícula.
	 */
	 ...
	 * 
	 * @param melhorPosicao a melhor posição já encontrada pela partícula.
	 */
	...
	/**
	 * Retorna a velocidade atual da partícula.
	 * Dimension
	 ...
	 * 
	 * @param velocidade a velocidade atual da partícula.
	 */
	 ...
	 * 
	 * @param melhorParticulaVizinhanca A partícula da vizinhança desta partícula que possui a melhor posição.
	 */
